...
export const FeatureSection = () => {
  return (
    <section className="text-center">
     ...
     <p className="text-xl text-slate-600 px-[24%] py-6"> Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups. </p>

     <div className="mx-[6%] flex flex-wrap justify-around">
     <div className="w-2/6 px-2 py-6 my-4">
      ...
      <div className="w-2/6 px-2 py-6 my-4">
       <p className="border shadow rounded-lg mx-[43.5%] px-2 py-2"> <RiChatSmile2Line size="2rem" /> </p>
      ...
      <div className="w-2/6 px-2 py-6 my-4">
       <p className="border shadow rounded-lg mx-[43.5%] px-2 py-2"> <MdKeyboardCommandKey size="2rem" /> </p>
      ...
      <div className="w-2/6 px-2 py-6 my-4">
       <p className="border shadow rounded-lg mx-[43.5%] px-2 py-2"> <BsChatHeart size="2rem" /> </p>
