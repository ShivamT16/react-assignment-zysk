...
import imageSM from "../assets/featureImage.png"
...
export const FeaturesSection = () => {
  return (
    <section className='text-center'>
        ...
        <p className="text-xl text-slate-600 text-center px-4 md:px-[24%]"> Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups. </p>

        <img src={imageMD} alt="features" className="hidden py-12 px-[14%] md:flex" />
        <img src={imageSM} alt="features" className="py-12 px-[14%] md:hidden" />

        <div className="mx-[6%] text-center md:flex flex-wrap justify-around">
