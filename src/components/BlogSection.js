  ...
  return (
    <section className="mx-[6%]">
        <div className="flex justify-between items-center">
            ...
            <button className="py-3 px-4 m-6 rounded-lg text-white bg-purple-600 font-medium"> View all posts </button>
        </div>
        ...
        <div className="w-1/3">
            <img src={uxReview} alt="uxReview" className="py-4" />
        ...
        <div className="w-1/3">
            <img src={product} alt="product" className="py-4" />
        ...
        <div className="w-1/3">
            <img src={software} alt="software" className="py-4" />
