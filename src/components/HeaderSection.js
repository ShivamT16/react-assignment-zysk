...
export const HeaderSection = () => {
    ...
    <main className="text-center pt-20">
     ...
     <div className="flex justify-center items-center">
      <button className="border border-gray-300 py-4 px-8 rounded-lg font-medium my-6 flex justify-center items-center gap-3"> <FiPlayCircle size="1.2rem" /> Demo </button>
