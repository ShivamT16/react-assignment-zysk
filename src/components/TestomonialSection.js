...
export const Testomonial = () => {
    return(
        <div className="text-center bg-gray-50 p-6 md:p-14 my-20">
            ...
            <p className="text-3xl md:text-5xl md:px-10 font-semibold leading-tight pb-6">Weve been using Untitled to kick start every new project and can't imagine working without it.</p>
